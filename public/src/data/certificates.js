...
const certificates = [
  ...
  },
  {
    ...
    title: {
      ar: "شهادة إنجاز — العمل الحر: من المهارة إلى فرصة العمل",
      en: "Certificate of Achievement — Freelancing: From Skill to Job Opportunity",
    },
    org: "IEEE Student Branch, Islamic University of Gaza · Aug 2026",
    desc: {
      ar: "شهادة حضور ورشة تمهيدية بعنوان \"Freelancing: From Skill to Job Opportunity\"، مدتها ساعتان، نظّمها فرع IEEE الطلابي بالجامعة الإسلامية بغزة بالتعاون مع ENGXPERT Academy عبر Google Meet.",
      en: "Awarded for attending a two-hour introductory workshop titled \"Freelancing: From Skill to Job Opportunity\", organized by the IEEE Student Branch at the Islamic University of Gaza in collaboration with ENGXPERT Academy, conducted online via Google Meet.",
    },
    skills: {
      ar: ["Freelancing", "Career Development", "Remote Work"],
      en: ["Freelancing", "Career Development", "Remote Work"],
    },
  },
];
